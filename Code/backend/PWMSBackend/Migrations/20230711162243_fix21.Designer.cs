...
namespace PWMSBackend.Migrations
{
    ...
    [Migration("20230711162243_fix21")]
    partial class fix21
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PWMSBackend.Models.MasterProcurementPlan", b =>
                {
                    ...
                    b.Property<double>("EstimatedGrandTotal")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PWMSBackend.Models.PaymentVoucher", b =>
                {
                    ...
                    b.Property<string>("PaymentVoucherEvidence")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PWMSBackend.Models.PurchaseOrder", b =>
                {
                    ...
                    b.Property<string>("BankGuarantee")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Bond")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CommentsForSpecialInstruction")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProcumentOfficerStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PWMSBackend.Models.UserNotificationsVendor", b =>
                {
                    b.Property<string>("NotificationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("NotificationId", "VendorId");

                    b.HasIndex("VendorId");

                    b.ToTable("UserNotificationsVendors");
                });
            ...
            modelBuilder.Entity("PWMSBackend.Models.Vendor", b =>
                {
                    ...
                    b.Property<string>("TaxIdentificationDoc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PWMSBackend.Models.VendorPlaceBidItem", b =>
                {
                    ...
                    b.Property<string>("LetterOfAcceptance")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PWMSBackend.Models.ItemInStock", b =>
                {
                    ...
                    b.Property<double>("TotalIssuePrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PWMSBackend.Models.UserNotificationsVendor", b =>
                {
                    b.HasOne("PWMSBackend.Models.UserNotification", "UserNotification")
                        .WithMany("UserNotificationsVendors")
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PWMSBackend.Models.UserNotification", b =>
                {
                    ...
                    b.Navigation("UserNotificationsVendors");
                });
