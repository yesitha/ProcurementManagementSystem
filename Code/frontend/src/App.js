...
import EvaluateVendorFinanceStatus
    from "./pages/Procurement Officer/Evaluate Vendor Finance Status/EvaluateVendorFinanceStatus";
...
const PrivateRoute = ({authorized, allowedUserTypes, ...props}) => {
    ...
    } else if (!allowedUserTypes.includes(user?user.userType:"")) {
