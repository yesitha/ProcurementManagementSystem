...
import { GetInvoiceDetails, UpdateInvoicePaymentStatus } from "../../../services/ProcurementHOD/ProcurementHODServices";
        ...
        >
          <div className={styles.downcontainer}>
            ...
            <h4>
                ...
                <br />
                Total Amount: {MoneyFormat(data.invoiceDto.tax+data.invoiceDto.totalAmount)}
              </h4>
            </Typography>
          </div>
          <center>
