...
function ItemDetails() {
    return (
        <div style={{overflowX:'hidden'}}>
            ...
            <Container sx={{ ml: { xs: "40px", sm: "65px", md: "65px", lg: "68px", xl: "70px" } }}>
                ...
                <div className='bottomSection'>
                    <Paper elevation={6} sx={{ pl: {xs:2,md:8}, pr: { lg: 15, md: 5 }, ml: { lg: 2.5, md: 1 }, borderRadius: 10 ,position:'absolute',pt:5}}>
                       ...
                       <div>
                            ...
                            <div className={Styles.doneButtonOuter}>
                                    <Button className={Styles.doneButton} variant="contained">Done</Button>
                                    </div>
                       </div>
                    </Paper>
                </div>
