...
switch (currentUser) {
  ...
  case 'HOD':
    ...
    actionButtons = [
      { displayName: "New Master Procurement plan for Evaluate",path:'new-master-procurement-plan-for-evaluate', number: "2" },
      { displayName: "New Finalized Master Procurement plan",path:'new-finalized-master-procurement-plan', number: "3" }
    ];
    break;
    ...
    actions = [
      ...
      path: "view-invoice"},
      {displayName: "Items to be Shipped",
    ...
    actionButtons = [
      ...
      {displayName: "New Purchase Order" ,path:'new-purchase-order',number:"2"},
    ...
    actions = [
      ...
      path: "view-stock"},
      {displayName: "View Assets Registry",
