      ...
      >
        ...
        <div className={styles.header2Section}>
            <Container sx={{mr:{xs:4,sm:5,lg:1},py:1,borderRadius:5}} className={styles.detailsSection}>
              <Typography  sx={{fontFamily:'mulish',fontSize:{xs:'12px',sm:'15px',md:'16px'},color:'#ffffff'}}>MASTER PROCUREMENT ID : {item['Master Procurement ID']}</Typography>
              <Typography  sx={{fontFamily:'mulish',fontSize:{xs:'12px',sm:'15px',md:'16px'},color:'#ffffff'}}>CREATED DATE : {creationDate}</Typography>
              <Typography  sx={{fontFamily:'mulish',fontSize:{xs:'12px',sm:'15px',md:'16px'},color:'#ffffff'}}>ITEM ID : {item['Item ID']}</Typography>
            </Container>
          </div>
