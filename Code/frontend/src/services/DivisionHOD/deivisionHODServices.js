...
export const addNewItemDb = async (itemName, itemSpecification, selectedCategoryId, selectedItemType
    ...
    try {
        await axios.post(
            `${process.env.REACT_APP_API_HOST}/api/DivisionHOD/AddItem?itemName=${itemName}&specification=${itemSpecification}&categoryId=${selectedCategoryId}&itemType==${selectedItemType}`
        );
