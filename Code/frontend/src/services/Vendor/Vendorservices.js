...
export const GetApprovedItemsDetailsvendorId = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetApprovedItemsDetails/${vendorId}`);
...
export const GetApprovedItemDetailsitemId = async (itemId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetApprovedItemDetails/${itemId}`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const CreateVendorPlaceBidItem = async (vendorId, itemId, bidValue) => {
    try {
        const response = await axios.put(`${process.env.REACT_APP_API_HOST}/api/Vendor/CreateVendorPlaceBidItem?vendorId=${vendorId}&itemId=${itemId}&bidValue=${bidValue}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const GetBidHistory = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetBidHistory/${vendorId}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const GetPODetailsbyId = async (poId) => {
    try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetPOVendorDetails/${poId}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const fetchAlreadyUploadedPDf = async (poId) => {
    try {
        console.log("reached");
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetUploadedPdf/${poId}`);
        console.log(response);
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetPurchaseOrdersByVendorId = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetPurchaseOrdersByVendorId/LAH23201`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetLetterAcceptenceData = async (itemId, venderId) => {
    try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetLetterOfAcceptanceItemAndVendorDetails/${venderId}/${itemId}`);
        console.log(response);
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetPOItemDetailspoIdvendorId = async (poId, vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetPOItemDetails/${poId}/LAH23201`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const getVendorVerifyPdfs = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetVendorVerifyPdf/${vendorId}`);
        console.log(response);
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetGRNIdListByVendorId = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetGRNIdListByVendorId/HEL9863`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetGRNItemDetails = async (poId, grnId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetGRNItemDetails/${poId}/${grnId}`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetInvoiceItemDetails = async (poId, grnId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetInvoiceItemDetails/${poId}/${grnId}`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const CreateInvoice = async (grnId) => {
    try {
        const response = await axios.post(`${process.env.REACT_APP_API_HOST}/api/Vendor/CreateInvoice?grnId=${grnId}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const getPOItems = async (poId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetPOItemDetails/${poId}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const GetItemToBeShippedDetails = async (poId, vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetItemToBeShippedDetails/${poId}/${vendorId}`);
...
export const GetInvoiceDetails = async (grnId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetInvoiceDetails/${grnId}`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetPOIdListByVendorId = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetPOIdListByVendorId/${vendorId}`);
...
export const CreatePurchaseOrderItemsToBeShippedRecords = async (poId, input) => {
    const data = Object.keys(input).map((key) => ({
        itemId: key, shippedQuantity: Number(input[key])
    }));
    try {
...
export const UpdateInvoiceDetails = async (invoiceId, total, tax) => {
    try {
        const response = await axios.put(`${process.env.REACT_APP_API_HOST}/api/Vendor/UpdateInvoiceDetails?invoiceId=${invoiceId}&total=${total}&tax=${tax}`);
        console.log(response);
        return response.data;
    } catch (error) {
        console.log(error);
...
export const GetInvoiceIdsForVendor = async (vendorId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetInvoiceIdsForVendor/HEL9863`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
...
export const GetInvoice = async (invoiceId) => {
    try {
        const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/Vendor/GetInvoice/${invoiceId}`);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;
