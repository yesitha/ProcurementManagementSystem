...
export default function BasicModal() {
  ...
  return (
    <div>
        <IconButton onClick={handleOpen} sx={{width:'40px',height:'40px',px:0.5}} className={styles.rejectButton}><CloseIcon/></IconButton>
      ...
      >
        <Box sx={style}>
          ...
          <Button onClick={handleClose} variant='contained' fontFamily={'Inter'} sx={{bgcolor: '#a62c55', borderRadius: 5, height: 40, width: 100,mt:3,"&:hover":{bgcolor:'#b23e65'}}}>OK</Button>
          </Container>
        </Box>
      </Modal>
    </div>
